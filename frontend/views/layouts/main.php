...
<!--                        --><?php //var_dump(Yii::$app->controller->action->uniqueId ); ?>
                ...
                <?php else: ?>
                    <div class="header__auth">
                        <a class="header__auth-link" href="<?=Url::toRoute('/message/index')?>" data-count="18">
                        ...
                        <div class="header__auth-box">
                            <a class="header__auth-user" href="<?= Url::toRoute('/profile') ?>">
    ...
    <nav class="menu" data-simplebar>
        ...
        <ul class="menu__list">
            <?php if(Yii::$app->user->isGuest) : ?>
            <li class="menu__list-item"><a class="menu__list-link" href="#"><?= Yii::t('app', 'Пользовательское соглашение') ?></a></li>
            <li class="menu__list-item"><a class="menu__list-link" href="<?= Url::toRoute('/top') ?>"><?= Yii::t('app', 'Топ 100') ?></a></li>
            <li class="menu__list-item"><a class="menu__list-link" href="<?= Url::toRoute('/pay/last') ?>"><?= Yii::t('app', 'Последние выплаты') ?></a>
            </li>
            ...
            <?php else: ?>
                <li class="menu__list-item"><a class="menu__list-link" href="/profile.html"><?= Yii::t('app', 'Профиль') ?></a></li>
                <li class="menu__list-item"><a class="menu__list-link" href="/balance.html"><?= Yii::t('app', 'Баланс') ?></a></li>
                <li class="menu__list-item"><a class="menu__list-link" href="/feed.html"><?= Yii::t('app', 'Стена') ?></a></li>
                <li class="menu__list-item"><a class="menu__list-link" href="/friends.html"><?= Yii::t('app', 'Друзья') ?></a></li>
                ...
                <li class="menu__list-item"><a class="menu__list-link" href="<?= Url::toRoute('/bonus') ?>">Бонус</a></li>
