...
?>
    ...
    <div class="popup popup-login" id="login">
        ...
        <div class="popup__label popup__label--row">
            ...
            <div class="popup__label-col">
                <a class="popup__link subtitle js-open-popup" href="javascript:void(0)" data-popup-link="#reset"><?= Yii::t('app', 'Забыли пароль?') ?></a>
            </div>
        </div>
        ...
        <div class="popup__buttons">
            ...
            <button class="popup__btn btn js-open-popup" data-popup-link="#registration" onclick=""><?= Yii::t('app', 'Регистрация') ?></button>
        </div>
        <?php
            ActiveForm::end();
        ?>
    ...
    <div class="popup popup-reset" id="reset">
        <h3 class="popup__title title title--size-small title--align-center"><?= Yii::t('app', 'Восстановление пароля') ?></h3>
        <?php
        ...
        ?>
        <div class="popup__label">
            <span class="popup__text">Пожалуйста, заполните ваш адрес электронной почты. <br>
Ссылка для сброса пароля будет отправлена туда.</span>
            <?php echo $form->field($signup_model, 'email', ['options'=>['class'=>'input popup__group']])->input('email')->label(false)
                ->textInput(['class' => 'popup__input input', 'placeholder' => 'Email']); ?>
        </div>
        ...
        <span class="popup__error error"></span>
        <div class="popup__label--row">
            <button type="submit" class="popup__btn btn"><?= Yii::t('app', 'Отправить') ?></button>
            <button id="login-btn" data-fancybox-close class="popup__btn link link--color-white popup__btn--margin"><?= Yii::t('app', 'Отмена') ?></button>
        </div>
        <?php
        ActiveForm::end();
        ?>
